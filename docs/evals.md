...
| account | industry_context | run_completed | runtime_seconds | evidence_card_count | high_confidence_evidence_count | contact_count | account_score | priority_label | quality_gate_verdict | risk_flag_count | unsupported_claim_count | llm_calls | input_tokens | output_tokens | cost_usd | report_generated | notes_errors |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
