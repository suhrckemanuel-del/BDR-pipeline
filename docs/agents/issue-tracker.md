...
- **Blocking**: GitHub's native issue dependencies where available; otherwise a `Blocked by: #<n>` line at the top of the child body. A ticket is unblocked when every blocker is closed.
